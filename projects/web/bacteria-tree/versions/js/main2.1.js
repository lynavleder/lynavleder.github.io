...
function init() {
    ...
    function updateWindowSize() {
            if(window.matchMedia('(min-width: 650px)')) {
                $('#infovis').css("background-color", "red");
                xOffset= 500
                yOffset= 0
            } else if (window.matchMedia('(min-width: 950px)')) {
                $('#infovis').css("background-color", "orange");
                xOffset= 300
                yOffset= 0
            } else if (window.matchMedia('(min-width: 1250px)')) {
                $('#infovis').css("background-color", "aqua");
                xOffset= 100
                yOffset= 0
            } else {
                $('#infovis').css("background-color", "goldenrod");
            }
            return xOffset, yOffset;   
    }
